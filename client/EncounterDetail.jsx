...
export class EncounterDetail extends React.Component {
  ...
  determineButtons(encounterId) {
    if (encounterId) {
      return (
        <div>
          <RaisedButton id="updateEncounterButton" label="Save" className="saveEncounterButton" primary={true} onClick={this.handleSaveButton.bind(this)} style={{marginRight: '20px'}}  />
          <RaisedButton id="deleteEncounterButton" label="Delete" onClick={this.handleDeleteButton.bind(this)} />
        </div>
      );
    } else {
      return (
        <RaisedButton id="saveEncounterButton" label="Save" primary={true} onClick={this.handleSaveButton.bind(this)} />
      );
    }
  }
